    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      AFRAME.registerComponent("navigation-controls", {
        ...
        init: function () {
          ...
          teleportEntity = this.teleportEntity =
        ...
        tick: (function () {
          ...
          return function (time, delta) {
            ...
            this.numActivePoints =
              (this.data.curveNumberPoints * timeSinceDrawStart) /
            ...
            if (this.data.type === "parabolic") {
              ...
              const numPoints = this.data.drawIncrementally
                ? this.numActivePoints
                : this.line.numPoints;
              ...
              for (
                var j = this.lastDrawnIndex + 1;
                j < this.line.numPoints;
                j++
              ) {
              ...
              next
                ...
                .add(
                  auxDirection
                    .copy(direction)
                    .multiplyScalar(this.data.maxLength)
                );
        ...
        onButtonUp: (function () {
          ...
          return function (evt) {
            ...
            if (teleportOrigin) {
              teleportOrigin.object3D.getWorldPosition(
                teleportOriginWorldPosition
              );
              this.newRigWorldPosition
                .sub(teleportOriginWorldPosition)
                .add(this.rigWorldPosition);
            }

            // Always keep the rig at the same offset off the ground after teleporting
            this.newRigWorldPosition.y =
              this.rigWorldPosition.y + this.hitPoint.y - this.prevHitHeight;
            ...
            if (this.data.robotNav) {
              ...
              if (!this.data.cameraRig) {
                var hands = document.querySelectorAll(
